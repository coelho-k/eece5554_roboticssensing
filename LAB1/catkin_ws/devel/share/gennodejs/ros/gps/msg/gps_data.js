...
class gps_data {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int64(obj.utm_easting, buffer, bufferOffset);
    // Serialize message field [utm_northing]
    bufferOffset = _serializer.int64(obj.utm_northing, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.utm_easting = _deserializer.int64(buffer, bufferOffset);
    // Deserialize message field [utm_northing]
    data.utm_northing = _deserializer.int64(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '74ea169e4292230a2f91acbde1213ed4';
  }
