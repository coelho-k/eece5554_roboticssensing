...
set(MSG_I_FLAGS "-Igps:/home/kyle/catkin_ws/src/gps/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kyle/catkin_ws/src/gps/msg/gps_data.msg" NAME_WE)
add_custom_target(_gps_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gps" "/home/kyle/catkin_ws/src/gps/msg/gps_data.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(gps
  "/home/kyle/catkin_ws/src/gps/msg/gps_data.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps\")")
  # install generated code
  install(
