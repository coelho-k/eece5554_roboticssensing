...
void OnSegmentClouds(
    ...
    /* START CUSTOM CODE -VV */
        ...
        autosense::VolumetricModel vmCar;
        vmCar.model_type = CAR;
        vmCar.l_min = 20; vmCar.l_max = 50;
        vmCar.w_min = 20; vmCar.w_max = 50;
        vmCar.h_min = 20; vmCar.h_max = 50;

        autosense::VolumetricModel vmPer;
        vmPer.model_type = PEDESTRIAN;
        vmPer.l_min = 0.2; vmPer.l_max = 1.0;
        vmPer.w_min = 0.2; vmPer.w_max = 1.0;
        vmPer.h_min = 0.2; vmPer.h_max = 2.0;
        autosense::roi::humanCarModelFilter(objects,
                vmPer,
                vmCar,
                &objects);
